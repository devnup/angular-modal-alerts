...
angular.module('com.devnup.alert', [])
  ...
  .factory('templateEngine', [
    ...
    function ($http, $templateCache, $compile) {
       ...
       *
       * @param {HTMLElement|String} [element] The HTML element or its selector for jqLite
       * @param {String} [templateUrl] The url for the template HTML file
       */
      return function (element, templateUrl) {
      ...
      var methods = {
        ...
        config: function (input) {
          ...
          if (input && input.preloader) {
            console.error('angular modal alerts: Preloader deprecated. Ignoring config...');
